class Parking {
  ...
  final String parkingType;  // Computed properties for compatibility
  ...
  String get name => address; // Use address as name for compatibility
  int get totalSpaces => 1; // Default to 1 space since API doesn't provide this info
  
  // Parse availableFrom and availableTo to get available hours
  List<int> get availableHours {
    try {
      if (availableFrom == null || availableTo == null) {
        return List.generate(12, (index) => 8 + index);
      }
      ...
      return List.generate(toHour - fromHour, (index) => fromHour + index);
    } catch (e) {
      return List.generate(12, (index) => 8 + index);
    }
  }
